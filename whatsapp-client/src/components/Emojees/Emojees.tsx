    ...
    return (
        <div className={s.emojiContainer}>
            <div className={s.category}>
                <span
                    className={
                        presentVisibleCat === "RecentEmojees" ? s.activeSvg : ""
                    }
                ...
                <span
                    className={
                        presentVisibleCat === "Smileys&People"
                            ? s.activeSvg
                            : ""
                    }
                ...
                <span
                    className={
                        presentVisibleCat === "Animals&Nature"
                            ? s.activeSvg
                            : ""
                    }
                ...
                <span
                    className={
                        presentVisibleCat === "Food&Drinks" ? s.activeSvg : ""
                    }
                ...
                <span
                    className={
                        presentVisibleCat === "Activity" ? s.activeSvg : ""
                    }
                ...
                <span
                    className={
                        presentVisibleCat === "Travel&Places" ? s.activeSvg : ""
                    }
                ...
                <span
                    className={
                        presentVisibleCat === "Objects" ? s.activeSvg : ""
                    }
                ...
                <span
                    className={
                        presentVisibleCat === "Shorts" ? s.activeSvg : ""
                    }
                ...
                <span
                    className={
                        presentVisibleCat === "Symbols" ? s.activeSvg : ""
                    }
              ...
              return <p dangerouslySetInnerHTML={{ __html: e.code_decimal }} />;
                ...
                {query ? (
                    ...
                    emojiList.map((e) => {
                        return (
                            <div className={s.classWiseEmojees}>
                                <a id={e.title.toString().replaceAll(" ", "")}>
                                    {e.title}
                                </a>
                                {/* @ts-ignore */}
                                <div className={s.emos}>
