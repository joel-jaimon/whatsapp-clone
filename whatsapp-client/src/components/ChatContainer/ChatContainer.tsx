...
import idleImage from "./bg-url.jpg";
          ...
          <div className={s.idleWrapper}>
            <div className={s.idleDiv}>
              ...
              <div className={s.socialLinks}>
                <img
                  onClick={() => handleLink("https://www.joeljaimon.com")}
                  className={s.icon}
                  src="https://www.joeljaimon.com/joel-avatarr.png"
                  alt="my-avatar"
                />
                <svg
                  onClick={() =>
                    handleLink("https://www.linkedin.com/in/joel-jaimon/")
                  }
                ...
                <svg
                  onClick={() => handleLink("https://github.com/joel-jaimon")}
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  className={s.icon}
                  viewBox="0 0 16 16"
                ...
                <svg
                  onClick={() =>
                    handleLink("https://www.instagram.com/joel__jaimon/")
                  }
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  className={s.icon}
